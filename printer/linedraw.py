...
import printer.perlin as perlin
from printer.filters import *
from printer.strokesort import *
from printer.util import *

no_cv = False
export_path = r"/home/pi/Project/Personal-Writer/printer/out.svg"
draw_contours = True
draw_hatch = True
show_bitmap = False
resolution = 1024
...
def sketch(path):
    ...
    lines = []
    if draw_contours:
        lines += get_contours(IM.resize((resolution // contour_simplify, resolution // contour_simplify * h // w)),
                              contour_simplify)
    if draw_hatch:
